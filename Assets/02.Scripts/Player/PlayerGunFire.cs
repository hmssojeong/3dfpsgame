...
public class PlayerGunFire : MonoBehaviour
{
    ...
    private void Fire()
    {
        ...
        if (isHit)
        {
            ...
            {
                StartCoroutine(DrawBulletTrail(startPos, endPos));
            }
            else
            {
                endPos = ray.GetPoint(100f);
            }

        }
    }

    private IEnumerator DrawBulletTrail(Vector3 startPos, Vector3 endPos)
    {
        LineRenderer trail = Instantiate(_bulletTrailPrefab);
        ...
        while (elapsedTime < travelTime)
        {
            ...
            trail.SetPosition(1, currentPos);
