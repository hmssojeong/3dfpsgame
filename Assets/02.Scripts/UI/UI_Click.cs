...
public class UI_Click : MonoBehaviour
{
    ...
    // 유튜브 패턴이란 :          유튜버      의  영상이  올라올때마다     구독자에게                    알림을 주는
    ...
    {
        _leftClickCountTextUI.text = $"왼쪽클릭: {ClickManager.Instance.LeftClickCount}번";
        _rightClickCountTextUI.text = $"오른쪽클릭: {ClickManager.Instance.RightClickCount}번";
    }
}
